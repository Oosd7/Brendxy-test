    ...
    return (
        ...
        <div className="section" ref={ref} style = {{backgroundImage:`url(${bg2})`}}>
                <div className="section__inner">
                    ...
                    consectetur adipisicing elit. Nisi maxime nesciunt impedit dolorum commodi aspernatur aperiam? Fugit obcaecati fuga quia, eligendi recusandae enim commodi aliquam velit unde saepe, distinctio dolores.
